...
Sun.prototype = {
    ...
    _init: function () {
        ...
        this.camera = new THREE.PerspectiveCamera( 18, window.innerWidth / window.innerHeight, 1,
            10000 );
        this.camera.position.set( 600, 300, 1100 );
    ...
    createDisplay1: function ( obj ) {
        ...
        mesh_text.rotation.y = Math.PI / 6;//Math.PI / 8;
    ...
    updateDisplay: function ( data ) {
        ...
        _.each( self.displays1, function ( value, key ) {
            ...
            switch ( model[key].model_id ) {
                case 'CNC_001':
                    self._update_cnc_001(self.machines[key], s_color);
                    break;
                case 'CNC_003':
                    self._update_cnc_003(self.machines[key], s_color);
                    break;
                case 'CNC_004':
                    self._update_cnc_004(self.machines[key], s_color);
                    break;
                case 'CNC_007':
                    self._update_cnc_007(self.machines[key], s_color);
                case 'CNC_008':
                    self._update_cnc_008(self.machines[key], s_color);
            }
